...
static BOOL SetDefaultDllDirectories_(DWORD flags)
{
    ...
    BOOL (WINAPI *SetDefaultDllDirectoriesReal)(DWORD);			// sunqueen modify
...
#endif
#if _WIN32_WINNT < _WIN32_WINNT_WIN8
    BOOL (WINAPI *SetProcessMitigationPolicy)(PROCESS_MITIGATION_POLICY, PVOID, SIZE_T);			// sunqueen modify
...
# define PROCESS_DEP_ENABLE 1
    ...
    //SetDefaultDllDirectories(LOAD_LIBRARY_SEARCH_SYSTEM32);		// sunqueen delete
    /***
