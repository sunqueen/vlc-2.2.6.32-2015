...
static const char qt_meta_stringdata_SPrefsPanel[] = {
    ...
    "langChanged(int)\0assoDialog()\0,\0"
    "updateCheckBoxes(QTreeWidgetItem*,int)\0"
    "saveAsso()\0configML()\0changeStyle(QString)\0"
};
...
void SPrefsPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->updateCheckBoxes((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 6: _t->saveAsso(); break;
        case 7: _t->configML(); break;
        case 8: _t->changeStyle((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
