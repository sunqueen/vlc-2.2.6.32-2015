...
static const char qt_meta_stringdata_MainInputManager[] = {
    ...
    "loopRepeatLoopStatus()\0changeFullscreen(bool)\0"
    "notifyRandom(bool)\0notifyRepeatLoop(bool)\0"
    "notifyVolume(float)\0notifyMute(bool)\0"
    "menusUpdateAudio(QString)\0"
};
